...
| 4 | [`design/04_decisions_log.md`](./design/04_decisions_log.md) | L2 | 决策 **D01–D28** |
| 5 | [`design/05_board_layout_consensus.md`](./design/05_board_layout_consensus.md) | L2 | 牌阵几何 |
| 6 | [`design/19_ios_renderer_lifecycle.md`](./design/19_ios_renderer_lifecycle.md) | L2 | **D28** 视图可丢弃 · rehydrate |
...
src/render/        cards · phys · gameView · cardAssets · app
...
| **改 iOS / 后台空白** | **design/19 · D28** → gameView · appLifecycle → ios_roundup |
